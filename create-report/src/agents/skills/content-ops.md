keywords: 콘텐츠, content, 품질, quality, 평가, evaluation, 점수, score, 전문가, expert panel, 랜딩, copy
<!-- 출처: github.com/ericosiu/ai-marketing-skills — 참고용 플레이북. preamble의 python/bash 스크립트는 이 프로젝트에서 실행하지 않음 -->
