    ...
    <PageWrapper>
      ...
      <ReportPage>
        ...
        <div>
          <SectionHeading
            overline="카테고리 분석"
            title="기능 오류와 결제/환불 두 카테고리가 전체 NPS -18을 끌어내리고 있으며, 지연율도 다른 카테고리보다 3~7배 높습니다"
        ...
        <div>
          <SectionHeading
            ...
            description="세 가지 원인이 맞물려 있습니다 — 두 카테고리(기능 오류·결제/환불)에 쏠린 불만, 처리시간이 길수록 만족도가 떨어지는 패턴, 카테고리 특성을 무시한 일괄 SLA."
          />
          <ReportSection>
            <SectionCard>
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "stretch" }}>
                <SignalCard
                  number={1}
                  title="두 카테고리가 전체 NPS를 끌어내림"
                  items={[
                    "첫째, 기능 오류와 결제/환불 두 카테고리가 전체 NPS를 끌어내리고 있습니다.",
                    "두 카테고리만 개선해도 전체 NPS가 회복될 만큼 나머지와 격차가 크며, 전담 자원과 우선순위 체계가 없어 처리 지연이 만족도 하락으로 이어집니다.",
                  ]}
                  bordered={false}
                />
                <SignalCard
                  ...
                  items={[
                    "둘째, 처리시간이 곧 만족도입니다.",
                    "모든 카테고리에서 처리시간이 길수록 NPS가 낮아지는 패턴이 반복되며, 처리시간이 22시간을 넘어가면 비추천자 비율이 56~68%까지 급격히 올라갑니다.",
                  ]}
                  bordered={false}
                />
                <SignalCard
                  number={3}
                  title="카테고리 특성과 무관한 일괄 SLA"
                  items={[
                    "셋째, 카테고리마다 특성이 다른데 SLA는 동일하게 적용되고 있습니다.",
                    "처리시간이 4배 이상 차이 나는 카테고리들이 공통 대기열에서 동일한 순서로 처리되어, 복잡한 카테고리일수록 처리가 늦어집니다.",
                  ]}
                  bordered={false}
                />
              </div>
